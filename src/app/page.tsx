...
export default function Home() {
  return (
    ...
    <div className="w-96 max-w-[370px] mx-auto flex gap-2 flex-col">
        <form className="bg-slate-800 py-10 px-5 rounded mt-32">
        <h1 className="text-white text-center text-2x1 mb-6">Adicionando com JS</h1>
        <div className="w-full">
            <input type="text" placeholder="Digite um item" className="w-full p-2 rounded" />
        </div>   
        ...
        <li className="p-3 bg-slate-800 text-white justify-between flex hover:bg-green-700 rounded-md">
            <span>item</span>
